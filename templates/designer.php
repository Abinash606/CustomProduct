...
?>
<div id="swp-ls-designer-app" class="swp-ls-container" 
     data-product-id="<?php echo esc_attr( $atts['product_id'] ); ?>" 
     data-variation-id="<?php echo esc_attr( $atts['variation_id'] ); ?>" 
     data-qty="<?php echo esc_attr( $atts['qty'] ); ?>" 
     data-bottle="<?php echo esc_attr( $atts['bottle'] ); ?>">
                ...
                <div class="panel-body">
                    ...
                    <div class="price-box mt-auto">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <strong class="text-primary" id="totalPrice">$120.00</strong>
                        </div>
                        <button class="btn btn-success w-100 rounded-pill fw-bold" onclick="saveAndAddToCart()">
                            <?php _e( 'Add to Cart', 'swp-label-studio' ); ?> <i class="fa-solid fa-cart-shopping ms-2"></i>
                        </button>
                    </div>
                </div>
            </div>
